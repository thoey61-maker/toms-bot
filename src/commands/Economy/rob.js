...
export default {
    ...
    execute: withErrorHandling(async (interaction, config, client) => {
        ...
        if (isSuccessful) {
            ...
            resultEmbed = MessageTemplates.SUCCESS.DATA_UPDATED("robbery", `You successfully stole **$${amountStolen.toLocaleString()}** from ${victimUser.username}!`);
        } else {
            ...
            resultEmbed = MessageTemplates.ERRORS.INSUFFICIENT_PERMISSIONS("robbery failed", `You failed the robbery and were caught! You were fined **$${fineAmount.toLocaleString()}** of your own cash.`);
        }
        ...
        resultEmbed
            ...
            .setFooter({ text: `No cooldown - rob anytime!` });
